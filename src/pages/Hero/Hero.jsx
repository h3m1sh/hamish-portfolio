...
const profile = {
    ...
    skills: [
        'React', 'Vite', 'PHP', 'Symfony',
        'Shopify', 'Liquid', 'JavaScript (ES6+)', 'Node.js',
        'MySQL', 'MongoDB', 'REST APIs', 'Git & GitHub'
    ],
    ecommerceExpertise: [
        'B2B Pricing Logic', 'Custom Shopify Development',
        'Production Ownership', 'Performance Optimization'
    ],
    ...
    hireable: function() {
        return (
            this.productionOwner &&
            this.independentDelivery &&
            this.problemSolver &&
  ...
  return (
    <>
      <main className="bg-[#020617] text-white min-h-screen">
        <section
          className="hero min-h-screen flex items-center justify-center relative px-4 sm:px-6 lg:px-8 pt-20 md:pt-16 lg:pt-0 pb-10 md:pb-16 lg:pb-0 hero-section-padding"
          style={{ paddingTop: "var(--hero-padding-top, 5rem)" }}
        >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Production e-commerce developer 🚀 | Shopify specialist 💻 | Building B2B systems that power real businesses ✨
                </p>
              </div>
              ...
              {/* Social Media Links */}
              <div className="flex items-center gap-4 mt-6 sm:mt-8 animate__animated animate__fadeInUp animate__delay-2.5s">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative p-3 rounded-lg bg-gray-800/50 border border-gray-700/50 hover:border-blue-500/50 hover:bg-gray-800 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20"
                    aria-label="GitHub Profile"
                  >
                    <FaGithub className="text-xl text-gray-400 group-hover:text-blue-400 transition-colors" />
                  </a>
                  <a
              ...
              <div className="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float">
                <div className="px-4 py-2 rounded-lg bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-400">
                  <i className="fas fa-store"></i>&nbsp;&nbsp;Shopify Expert
                </div>
              </div>
            </div>
